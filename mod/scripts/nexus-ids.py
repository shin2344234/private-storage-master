...
The mod page URL carries the page id, which is not the id the v3 API wants for either
...
def main():
    if not PAGE_ID:
        raise SystemExit("PAGE_ID is empty. Create the Nexus page first, then put its number in nexus-ids.py.")
